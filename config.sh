...
then
	...
	zypper -n --gpg-auto-import-keys install --allow-unsigned-rpm https://github.com/Kethen/opensuse_deck/releases/download/2024-07-21/deck-adaptation-for-opensuse-0.1-0.x86_64.rpm
fi
